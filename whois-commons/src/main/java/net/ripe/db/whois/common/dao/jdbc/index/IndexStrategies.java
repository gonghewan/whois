...
public final class IndexStrategies {
    ...
    static {
        final IndexStrategy[] indexStrategies = {
                ...
                new IndexWithConnp(AttributeType.CONN_P),
                ...
                new Unindexed(AttributeType.CERT_TYPE),
                new Unindexed(AttributeType.CERT_NO),
                new Unindexed(AttributeType.C_ADDRESS),
                new Unindexed(AttributeType.STREET),
                new Unindexed(AttributeType.C_STREET),
                new Unindexed(AttributeType.CITY),
                new Unindexed(AttributeType.C_CITY),
                new Unindexed(AttributeType.C_CITY_ID),
                new Unindexed(AttributeType.PROVINCE),
                new Unindexed(AttributeType.C_PROVINCE),
                new Unindexed(AttributeType.C_COUNTRY),
                new Unindexed(AttributeType.C_DISTRICT),
                ...
                new IndexWithName(AttributeType.C_NAME, "c_name"),
